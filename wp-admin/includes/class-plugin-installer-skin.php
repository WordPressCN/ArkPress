...
/**
 * Plugin Installer Skin for ArkPress Plugin Installer.
 *
 * @since 2.8.0
...
class Plugin_Installer_Skin extends WP_Upgrader_Skin {
	...
	public function after() {
		 ...
		 * @param object   $api             Object containing ArkPress.icu API plugin data. Empty
	...
	private function do_overwrite() {
		...
		$rows = array(
			...
			'Version'     => __( 'Version' ),
			'Author'      => __( 'Author' ),
			'RequiresWP'  => __( 'Required ArkPress version' ),
		...
		if ( ! is_wp_version_compatible( $requires_wp ) ) {
			$error = sprintf(
				/* translators: 1: Current ArkPress version, 2: Version required by the uploaded plugin. */
				__( 'Your ArkPress version is %1$s, however the uploaded plugin requires %2$s.' ),
		 ...
		 *
		 * @param string[] $install_actions Array of plugin action links.
		 * @param object   $api             Object containing ArkPress.icu API plugin data.
		 * @param array    $new_plugin_data Array with uploaded plugin data.
		 */
