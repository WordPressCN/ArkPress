 ...
 *
 * A client for api.arkpress.icu/events.
 *
 * @since 4.8.0
 */
class WP_Community_Events {
	 ...
	 * than having the browser make the request directly to api.arkpress.icu,
	...
	public function get_events( $location_search = '', $timezone = '' ) {
		...
		$api_url                    = 'http://api.arkpress.icu/events/1.0/';
		$request_args               = $this->get_request_args( $location_search, $timezone );
		$request_args['user-agent'] = 'WordPress/' . $wp_version . '; ArkPress/' . $wp_version . '; ' . home_url( '/' );
