...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from ArkPress database
	 *
	...
	/**
	 * Return count of imported permalinks from ArkPress database
	 *
	 * @global wpdb $wpdb ArkPress database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Set array with imported comments from ArkPress database
	 *
	 * @global wpdb $wpdb ArkPress database abstraction object.
	 *
	 * @param string $blog_id
