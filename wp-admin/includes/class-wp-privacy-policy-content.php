...
final class WP_Privacy_Policy_Content {
	...
	public static function get_default_content( $description = false, $blocks = true ) {
		...
		if ( $description ) {
			...
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'By default ArkPress does not collect any personal data about visitors, and only collects the data shown on the User Profile screen from registered users. However some of your plugins may collect personal data. You should add the relevant information below.' ) . '</p>';
		}
		...
		if ( $description ) {
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'In this subsection you should note what information is captured through comments. We have noted the data which ArkPress collects by default.' ) . '</p>';
		} else {
		...
		if ( $description ) {
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'In this subsection you should list the cookies your web site uses, including those set by your plugins, social media, and analytics. We have provided the cookies which ArkPress installs by default.' ) . '</p>';
		} else {
			/* translators: Default privacy policy text. */
		...
		if ( $description ) {
			...
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'By default ArkPress does not collect any analytics data. However, many web hosting accounts collect some anonymous analytics data. You may also have installed a ArkPress plugin that provides analytics services. In that case, add information from that plugin here.' ) . '</p>';
		}
		...
		if ( $description ) {
			...
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'By default ArkPress does not share any personal data with anyone.' ) . '</p>';
		} else {
			/* translators: Default privacy policy text. */
	...
	public static function add_suggested_content() {
		...
		wp_add_privacy_policy_content( __( 'ArkPress' ), $content );
	}
}
