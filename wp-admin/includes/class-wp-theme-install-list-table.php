...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	...
	/**
	 * Prints a theme from the ArkPress.icu API.
	 *
	 * @since 3.1.0
	 *
	 ...
	 *     An object that contains theme data returned by the ArkPress.icu API.
	 *
	 ...
	 *     @type string $screenshot_url Screenshot URL, e.g. 'https://arkpress.icu/themes/twentytwentyone/'.
	 *     @type float  $rating         Rating score.
	 *     @type int    $num_ratings    The number of ratings.
	 *     @type string $homepage       Theme homepage, e.g. 'https://arkpress.icu/themes/twentytwentyone/'.
	 ...
	 *
	 * @param stdClass $theme A ArkPress.icu Theme API object.
	 */
