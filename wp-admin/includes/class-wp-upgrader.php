...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_root_dir']    = __( 'Unable to locate ArkPress root directory.' );
		$this->strings['fs_no_content_dir'] = __( 'Unable to locate ArkPress content directory (wp-content).' );
		$this->strings['fs_no_plugins_dir'] = __( 'Unable to locate ArkPress plugin directory.' );
		$this->strings['fs_no_themes_dir']  = __( 'Unable to locate ArkPress theme directory.' );
	...
	/**
	 * Creates a lock using ArkPress options.
	 *
	 * @since 4.5.0
	 *
