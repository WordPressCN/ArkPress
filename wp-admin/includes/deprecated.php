<?php
/**
 * Deprecated admin functions from past ArkPress versions. You shouldn't use these
...
function get_screen_icon() {
	_deprecated_function( __FUNCTION__, '3.8.0' );
	return '<!-- Screen icons are no longer used as of ArkPress 3.8. -->';
}
...
/**
 * Display plugins text for the ArkPress news widget.
 *
 * @since 2.5.0
 * @deprecated 4.8.0
 *
