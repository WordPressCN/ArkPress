<?php
/**
 * ArkPress Administration Meta Boxes API.
 *
 * @package ArkPress
...
<p>
	...
	printf(
		...
		__( 'https://arkpress.icu/support/article/excerpt/' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		/* translators: %s: Documentation URL. */
		__( 'Trackbacks are a way to notify legacy blog systems that you&#8217;ve linked to them. If you link other ArkPress sites, they&#8217;ll be notified automatically using <a href="%s">pingbacks</a>, no other action necessary.' ),
		__( 'https://arkpress.icu/support/article/introduction-to-blogging/#comments' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( 'https://arkpress.icu/support/article/custom-fields/' )
	);
	?>
</p>
	<?php
...
<p class="meta-options">
	...
	<label for="ping_status" class="selectit"><input name="ping_status" type="checkbox" id="ping_status" value="open" <?php checked( $post->ping_status, 'open' ); ?> />
		...
		printf(
			...
			__( 'https://arkpress.icu/support/article/introduction-to-blogging/#managing-comments' )
		);
		?>
	</label>
	<?php
	 ...
	 */
	do_action( 'post_comment_status_meta_box-options', $post ); // phpcs:ignore ArkPress.NamingConventions.ValidHookName.UseUnderscores
	?>
</p>
	<?php
}
