<?php
/**
 * ArkPress Administration Scheme API
 *
...
/**
 * Create ArkPress options and set the default values.
 *
 * @since 1.5.0
 * @since 5.1.0 The $options parameter has been added.
 *
 * @global wpdb $wpdb                  ArkPress database abstraction object.
 * @global int  $wp_db_version         ArkPress database version.
...
function populate_options( array $options = array() ) {
	...
	/**
	 * Fires before creating ArkPress options and populating their default values.
	 *
	 * @since 2.6.0
	 */
	...
	$defaults = array(
		...
		'blogdescription'                 => __( 'Just another ArkPress site' ),
	...
	$existing_options = $wpdb->get_col( "SELECT option_name FROM $wpdb->options WHERE option_name in ( $keys )" ); // phpcs:ignore ArkPress.DB.PreparedSQL.NotPrepared
	...
	if ( ! empty( $insert ) ) {
		$wpdb->query( "INSERT INTO $wpdb->options (option_name, option_value, autoload) VALUES " . $insert ); // phpcs:ignore ArkPress.DB.PreparedSQL.NotPrepared
	}
...
/**
 * Execute ArkPress role creation for the various ArkPress versions.
 *
 * @since 2.0.0
 */
...
/**
 * Create the roles for ArkPress 2.0
 *
 * @since 2.0.0
 */
...
/**
 * Create and modify ArkPress roles for ArkPress 2.1.
 *
 * @since 2.1.0
 */
...
/**
 * Create and modify ArkPress roles for ArkPress 2.3.
 *
 * @since 2.3.0
 */
...
/**
 * Create and modify ArkPress roles for ArkPress 2.5.
 *
 * @since 2.5.0
 */
...
/**
 * Create and modify ArkPress roles for ArkPress 2.6.
 *
 * @since 2.6.0
 */
...
/**
 * Create and modify ArkPress roles for ArkPress 2.7.
 *
 * @since 2.7.0
 */
...
/**
 * Create and modify ArkPress roles for ArkPress 2.8.
 *
 * @since 2.8.0
 */
...
/**
 * Create and modify ArkPress roles for ArkPress 3.0.
 *
 * @since 3.0.0
 */
...
/**
 * Creates ArkPress network meta and sets the default values.
 *
 * @since 5.1.0
 *
 * @global wpdb $wpdb          ArkPress database abstraction object.
...
--The Team @ SITE_NAME'
	...
	$wpdb->query( "INSERT INTO $wpdb->sitemeta ( site_id, meta_key, meta_value ) VALUES " . $insert ); // phpcs:ignore ArkPress.DB.PreparedSQL.NotPrepared
}

/**
 * Creates ArkPress site meta and sets the default values.
 *
 * @since 5.1.0
 *
 * @global wpdb $wpdb ArkPress database abstraction object.
...
function populate_site_meta( $site_id, array $meta = array() ) {
	...
	$wpdb->query( "INSERT INTO $wpdb->blogmeta ( blog_id, meta_key, meta_value ) VALUES " . $insert ); // phpcs:ignore ArkPress.DB.PreparedSQL.NotPrepared
