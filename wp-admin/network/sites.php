...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://arkpress.icu/support/article/network-admin-sites-screen/">Documentation on Site Management</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://arkpress.icu/support/forum/multisite/">Support Forums</a>' ) . '</p>'
);
		...
		case 'allblogs':
			if ( isset( $_POST['action'] ) && isset( $_POST['allblogs'] ) ) {
				...
				if ( ! in_array( $doaction, array( 'delete', 'spam', 'notspam' ), true ) ) {
					...
					$redirect_to = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $redirect_to, $doaction, $blogs, $id ); // phpcs:ignore ArkPress.NamingConventions.ValidHookName.UseUnderscores
