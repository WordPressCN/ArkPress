...
/** Load ArkPress Translation Installation API */
...
if ( file_exists( ABSPATH . 'wp-config-sample.php' ) ) {
	...
	wp_die(
		sprintf(
			...
			__( 'Sorry, I need a %s file to work from. Please re-upload this file to your ArkPress installation.' ),
...
if ( @file_exists( ABSPATH . '../wp-config.php' ) && ! @file_exists( ABSPATH . '../wp-settings.php' ) ) {
	wp_die(
		'<p>' . sprintf(
			/* translators: 1: wp-config.php, 2: install.php */
			__( 'The file %1$s already exists one level above your ArkPress installation. If you need to reset any of the configuration items in this file, please delete it first. You may try <a href="%2$s">installing now</a>.' ),
			'<code>wp-config.php</code>',
			'install.php'
		) . '</p>',
		409
...
<head>
	...
	<title><?php _e( 'ArkPress &rsaquo; Setup Configuration File' ); ?></title>
...
<p><?php _e( 'Welcome to ArkPress. Before getting started, we need some information on the database. You will need to know the following items before proceeding.' ); ?></p>
<ol>
	<li><?php _e( 'Database name' ); ?></li>
	<li><?php _e( 'Database username' ); ?></li>
	<li><?php _e( 'Database password' ); ?></li>
	<li><?php _e( 'Database host' ); ?></li>
	<li><?php _e( 'Table prefix (if you want to run more than one ArkPress in a single database)' ); ?></li>
</ol>
<p>
		<?php
		printf(
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td id="dbname-desc"><?php _e( 'The name of the database you want to use with ArkPress.' ); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td id="prefix-desc"><?php _e( 'If you want to run multiple ArkPress installations in a single database, change this.' ); ?></td>
		</tr>
	</table>
		<?php
		if ( isset( $_GET['noapi'] ) ) {
...
<p><?php _e( 'All right, sparky! You&#8217;ve made it through this part of the installation. ArkPress can now communicate with your database. If you are ready, time now to&hellip;' ); ?></p>
