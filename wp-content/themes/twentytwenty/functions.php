...
/**
 * Sets up theme defaults and registers support for various ArkPress features.
 *
...
function twentytwenty_theme_support() {
	...
	/*
	 * Let ArkPress manage the document title.
	 * By adding theme support, we declare that this theme does not use a
	 * hard-coded <title> tag in the document head, and expect ArkPress to
	 * provide it for us.
	 */
...
if ( ! function_exists( 'wp_body_open' ) ) {
	...
	/**
	 * Shim for wp_body_open, ensuring backward compatibility with versions of ArkPress older than 5.2.
	 *
	 * @since Twenty Twenty 1.0
	 */
