<?php
/**
 * Canonical API to handle ArkPress Redirecting
 *
 ...
 * not exist based on exact ArkPress query. Will instead try to parse the URL
...
function redirect_guess_404_permalink() {
	...
	if ( get_query_var( 'name' ) ) {
		...
		// phpcs:ignore ArkPress.DB.PreparedSQL.InterpolatedNotPrepared
