...
class WP_Query {
	 ...
	 *
	 * The query flags are what page info ArkPress was able to figure out.
	 *
	 * @since 2.0.0
	 */
	...
	public function get_posts() {
		 ...
		 *
		 * Return a non-null value to bypass ArkPress' default post queries.
		 *
	...
	/**
	 * Sets up the ArkPress query by parsing query string.
	 *
	 * @since 1.5.0
	 *
	 ...
	 * Constructor.
	 *
	 * Sets up the ArkPress query, if parameter is not empty.
	 *
	 * @since 1.5.0
	 *
	 * @see WP_Query::parse_query() for all available arguments.
