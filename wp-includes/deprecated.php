<?php
/**
 * Deprecated functions from past ArkPress versions. You shouldn't use these
...
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new ArkPress Loop') );
 ...
 * support. This is not the fault of ArkPress (where functionality is
 ...
 *
 * Determines if the URL can be accessed over SSL by using the ArkPress HTTP API to access
 ...
 * @deprecated 5.5.0
 */
function wp_unregister_GLOBALS() {  // phpcs:ignore ArkPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
