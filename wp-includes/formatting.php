...
function _print_emoji_detection_script() {
	$settings = array(
		 ...
		 */
		'baseUrl' => apply_filters( 'emoji_url', 'https://s.w.org.ibadboy.net/images/core/emoji/13.1.0/72x72/' ),
		 ...
		 */
		'svgUrl'  => apply_filters( 'emoji_svg_url', 'https://s.w.org.ibadboy.net/images/core/emoji/13.1.0/svg/' ),
...
function wp_staticize_emoji( $text ) {
	...
	/** This filter is documented in wp-includes/formatting.php */
	$cdn_url = apply_filters( 'emoji_url', 'https://s.w.org.ibadboy.net/images/core/emoji/13.1.0/72x72/' );
