	...
	wp.api.utils.addMixinsAndHelpers = function( model, modelClassName, loadingObjects ) {
		...
		var hasDate = false,
			...
			TimeStampedMixin = {
				 ...
				 *
				 * @param {Date}   date   A JavaScript date object. ArkPress expects dates in UTC.
				 ...
				 *
				 * ArkPress returns 'date' and 'date_modified' in the timezone of the server as well as
