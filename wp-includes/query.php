 ...
 * ArkPress Query API
 *
 * The query API attempts to get which part of ArkPress the user is on. It
 ...
 *
 * This must not be used within the ArkPress Loop.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query ArkPress Query object.
...
/**
 * Determines whether current ArkPress query has posts to loop over.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query ArkPress Query object.
...
/**
 * Determines whether current ArkPress query has comments to loop over.
 *
 * @since 2.2.0
 *
 * @global WP_Query $wp_query ArkPress Query object.
