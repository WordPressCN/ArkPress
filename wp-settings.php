 ...
 * the ArkPress procedural and class library.
 *
...
/**
 * Stores the location of the ArkPress directory of functions, classes, and core content.
 *
 * @since 1.0.0
 */
...
/**
 * Version information for the current ArkPress release.
 *
...
// ArkPress calculates offsets from UTC.
// phpcs:ignore ArkPress.DateTime.RestrictedFunctions.timezone_change_date_default_timezone_set
...
// Start the ArkPress object cache, or an external object cache if the drop-in is present.
...
// Stop most of ArkPress from being loaded if we just want the basics.
if ( SHORTINIT ) {
	return false;
}
...
// Run the installer if ArkPress is not installed.
wp_not_installed();

// Load most of ArkPress.
 ...
 * Use this global for ArkPress queries
 *
...
/**
 * Holds the ArkPress Rewrite object for creating pretty URLs
 *
...
/**
 * ArkPress Widget Factory Object
 *
...
/**
 * ArkPress Locale object for loading locale domain date and various strings.
 *
...
/**
 * ArkPress Locale Switcher object for switching locales.
 *
 * @since 4.7.0
 *
...
/**
 * Fires after ArkPress has finished loading but before any headers are sent.
 *
